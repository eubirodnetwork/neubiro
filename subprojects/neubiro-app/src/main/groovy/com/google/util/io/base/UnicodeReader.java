...
package com.google.util.io.base;
...
public class UnicodeReader extends Reader {
  ...
  public UnicodeReader(String fname) throws IOException {
    this(new FileInputStream(fname), "UTF-8");
  }
  ...
  public UnicodeReader(String fname, String defaultEnc) throws IOException {
    this(new FileInputStream(fname), defaultEnc);
  }

  public UnicodeReader(File file, String defaultEnc) throws IOException {
    this(new FileInputStream(file), defaultEnc);
  }
