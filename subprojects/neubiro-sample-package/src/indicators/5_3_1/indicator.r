...
# Load implementation
source(paste(baseDir,"/5_3_1/implementation.r", sep=""))
...
biro_5_3_1(
   ...
   footnote="Table 5.3.1 HbA1c>9.0 by Type of Diabetes",
   title="5.3.1 HbA1c>9.0 by Type of Diabetes",
   section="5.3.1 HbA1c>9.0 by Type of Diabetes"
  )
