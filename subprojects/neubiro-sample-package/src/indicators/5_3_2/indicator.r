...
# Load implementation
source(paste(baseDir,"/5_3_2/implementation.r", sep=""))
...
biro_5_3_2(
   ...
   footnote="Table 5.3.2 HbA1c>7.5 by Type of Diabetes",
   title="5.3.2 HbA1c>7.5 by Type of Diabetes",
   section="5.3.2 HbA1c>7.5 by Type of Diabetes"
  )
