...
# Load implementation
source(paste(baseDir,"/2_2_3_4/implementation.r", sep=""))
...
biro_2_2_3_4(
   ...
   footnote="Table 2.2.3.4 HDL Cholesterol by Type of Diabetes",
   title="2.2.3.4 HDL Cholesterol by Type of Diabetes",
   section="2.2.3.4 HDL Cholesterol by Type of Diabetes"
  )
