...
# Load implementation
source(paste(baseDir,"/2_2_1_1/implementation.r", sep=""))
...
biro_2_2_1_1(
   ...
   x_levels_labs=c("&lt;50","[50-70)","[70-90)","[90,110)","[110-130)","&gt;=130"),
   ...
   footnote="Table 2.2.1.1 Weight by Type of Diabetes",
   title="2.2.1.1 Weight by Type of Diabetes",
   section="2.2.1.1 Weight"
  )
