...
# Load implementation
source(paste(baseDir,"/2_2_3_5/implementation.r", sep=""))
...
biro_2_2_3_5(
   ...
   xvar="CL_CREAT",
   xvar_label="Creatinine",
   x_levels=c("1","2","3","4"),
   x_levels_labs=c("&lt;45","[45-133)","[133-265)","&gt;=265"),
   ...
   footnote="Table 2.2.3.5 Creatinine by Type of Diabetes",
   title="2.2.3.5 Creatinine by Type of Diabetes",
   section="2.2.3.5 Creatinine by Type of Diabetes"
  )
