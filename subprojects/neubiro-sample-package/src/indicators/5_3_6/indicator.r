...
# Load implementation
source(paste(baseDir,"/5_3_6/implementation.r", sep=""))
...
biro_5_3_6(
   ...
   footnote="Table 5.3.6 Current smokers by Type of Diabetes",
   title="5.3.2 Current smokers by Type of Diabetes",
   section="5.3.2 Current smokers by Type of Diabetes"
  )
