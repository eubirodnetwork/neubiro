...
# Load implementation
source(paste(baseDir,"/5_3_4/implementation.r", sep=""))
...
biro_5_3_4(
   ...
   footnote="Table 5.3.4 BMI>30 by Type of Diabetes",
   title="5.3.4 BMI>30 by Type of Diabetes",
   section="5.3.4 BMI>30 by Type of Diabetes"
  )
