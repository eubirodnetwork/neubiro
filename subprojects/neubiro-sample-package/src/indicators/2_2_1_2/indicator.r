...
# Load implementation
source(paste(baseDir,"/2_2_1_2/implementation.r", sep=""))
...
biro_2_2_1_2(
   ...
   xvar="CL_BMI",
   xvar_label="Body Mass Index",
   x_levels=c("1","2","3","4"),
   x_levels_labs=c("&lt;18.5","[18.5-25)","[25-30)","&gt;=30"),
   ...
   footnote="Table 2.2.1.2 BMI by Type of Diabetes",
   title="2.2.1.2 BMI by Type of Diabetes",
   section="2.2.1.2 BMI"
  )
