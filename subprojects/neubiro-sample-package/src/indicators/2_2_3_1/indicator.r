...
# Load implementation
source(paste(baseDir,"/2_2_3_1/implementation.r", sep=""))
...
biro_2_2_3_1(
   ...
   xvar="CL_SBP",
   xvar_label="Systolic Blood Pressure",
   x_levels=c("1","2"),
   x_levels_labs=c("&lt;130","&gt;=130"),
   ...
   footnote="Table 2.2.3.1 Systolic Blood Pressure by Type of Diabetes",
   title="2.2.3.1 Systolic Blood Pressure by Type of Diabetes",
   section="2.2.3.1 Systolic Blood Pressure"
  )
